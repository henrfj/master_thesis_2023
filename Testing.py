...
def test_milkman_smarter_SC_update():
    ...
    gfx = Visualization(MAP_DIMENSIONS, pixels_per_unit=7, map_img_path="graphics/test_map_2.png")
    # Environment
    env = ClosedField_v21(sim_dt=sim_dt, decision_dt=decision_dt, render=False, v_max=v_max, v_min=v_min, alpha_max=alpha_max, tau_steering=tau_steering, tau_throttle=tau_throttle, horizon=200)
    env.reset()
    # vehicle
    car1 = env.vehicle
    objects = env.objects
