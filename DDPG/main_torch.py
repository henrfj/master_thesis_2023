...
import os
# My own env!
from environments import OpenField_v00, OpenField_v01, OpenField_v10, ClosedField_v20, ClosedField_v21
...
def v40_MPC_training(episodes=5000, sim_dt=0.1,decision_dt=0.1, plotting = 'DDPG/plots/openfield_v21.png', save_folder="DDPG/checkpoints/v21", loadfolder=None):

    env = ClosedField_v21(sim_dt=sim_dt, decision_dt=decision_dt, render=False, v_max=20, v_min=-4, alpha_max=0.5, tau_steering=0.5, tau_throttle=0.5, horizon=200)

    agent = Agent(alpha=0.000025, beta=0.00025, input_dims=[40], tau=0.1, env=env, tau=0.001
